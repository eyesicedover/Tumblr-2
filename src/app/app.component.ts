...
export class AppComponent {
  ...
  masterPostList: Post[] = [
    ...
    new Post("video", "gay-barbie", "bigbadberry", '<iframe width="560" height="315" src="https://www.youtube.com/embed/na7lIb09898?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'),
